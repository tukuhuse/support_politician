...
$(function (commentdelete) {
  $('.commentdelete').on('click', function () {
    var $this = $(this);
    var $commentid = $this.parent().find('input:hidden[name="commentid"]').val();
    $.ajaxSetup({
      headers: {
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
      }
...
module.exports = __webpack_require__(/*! /home/ec2-user/environment/support_politician/resources/js/comment.js */"./resources/js/comment.js");
